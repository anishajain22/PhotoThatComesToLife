...
def get_opts():
    ...
    parser.add_argument('--fps', type=float, default=10,
                        help='the fps rate for ar video')
    parser.add_argument('--aspect', type=float, default=0.5,
                        help='the aspect ratio of the window')
    parser.add_argument('--skip', type=float, default=2,
                        help='the skip rate for output video')
    
    # rotation invariant parameters
    parser.add_argument('--max-rotation', type=int, default=340,
                        help='the maximum rotation allowed for descriptor matching')
